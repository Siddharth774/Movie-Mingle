...
function Search({ query, setQuery }) {
  ...
  // Using DOM manipultaion to avoid this path we have to use refs hook in react.
  useEffect(function () {
          ...
          <section>
            <div className="rating">
              {!isWatched ? (
                ...
                <p>You have rated {watchedUserRating} ⭐ to this movie </p>
              )}
            </div>
...
// Reusable Component using the listBox earlier component as Box
